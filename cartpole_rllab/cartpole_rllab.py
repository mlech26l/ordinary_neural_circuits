...
class TWsearchEnv:
    ...
    def set_observations_for_lif(self,obs,observations):
        observations[0] = float(obs[2])
        observations[1] = float(obs[3])
    ...
    def load_tw(self,filename):
        ...
        self.lif.AddBiSensoryNeuron(1,6,-0.15,0.15)
        self.lif.AddBiSensoryNeuron(7,0,-1.0,1.0)
    ...
    def optimize(self,ts=datetime.timedelta(seconds=60)):
        ...
        while True:
            ...
            variance_vleak = rng.uniform(0.1,2)

            # vleak
            distortions_gleak = rng.randint(0,num_distortions_gleak)
            variance_gleak = rng.uniform(0.02,0.2)
            ...
            if(new_return > current_return):
                ...
                if(num_distortions_vleak<3):
                    num_distortions_vleak=3
